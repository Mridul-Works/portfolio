    ...
    <section className="sticky top-0 h-svh min-h-150 w-full overflow-hidden bg-[#050505] text-white">
      ...
      <header className="absolute inset-x-0 top-0 z-10 flex items-center justify-between px-6 py-6 sm:px-10">
        <a href="#" className="font-display text-xl font-bold tracking-tight">
          M<span className="text-[#d9ff3d]">.</span>
        </a>
        <nav className="flex items-center gap-6 text-xs tracking-[0.15em] text-white/50 sm:gap-8">
      ...
      <div className="pointer-events-none relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        <p className="mb-6 font-mono text-[11px] tracking-[0.3em] text-white/40">
        ...
        <h1 className="max-w-5xl font-display text-[clamp(2.2rem,6.2vw,5.5rem)] font-bold uppercase leading-[1.05] tracking-tight">
          Building immersive
          <br />
          web experiences<span className="text-[#d9ff3d]">.</span>
        </h1>
        ...
        <div className="pointer-events-auto mt-10">
          <a
            href="#work"
            className="group inline-flex items-center gap-2 border-b border-white/30 pb-1 text-sm tracking-wide text-white/80 transition-colors hover:border-[#d9ff3d] hover:text-white"
          >
            View selected work
      ...
      <footer className="absolute inset-x-0 bottom-0 z-10 flex items-center justify-between px-6 py-6 font-mono text-[10px] tracking-[0.2em] text-white/30 sm:px-10">
        <p>BASED IN INDIA</p>
