...
function Eye({
  ...
  return (
    <span className="eye-blink relative inline-flex h-[0.68em] w-[0.5em] items-center justify-center rounded-full bg-white align-baseline">
      <span
        ref={pupilRef}
        className="block h-[0.24em] w-[0.24em] rounded-full bg-[#050505] will-change-transform"
      />
    </span>
  );
}
...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative z-10 rounded-t-[2.5rem] bg-[#050505] text-white sm:rounded-t-[3.5rem]"
    >
      <div className="mx-auto flex min-h-svh max-w-5xl flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <h2 className="mt-10 font-display font-bold uppercase leading-[0.95] tracking-tight">
          <span className="block text-[clamp(3rem,10vw,8.5rem)]">Contact</span>
          <span className="mt-[0.05em] flex items-center justify-center gap-[0.08em] text-[clamp(3rem,10vw,8.5rem)]">
            M
            <Eye pupilRef={pupilL} />
            <Eye pupilRef={pupilR} />
          </span>
        ...
        >
          <span className="border-b border-white/25 pb-1 transition-colors group-hover:border-[#d9ff3d]">
            hello@mridul.dev
          </span>
        ...
        <div className="mt-14 flex items-center gap-8 font-mono text-xs tracking-[0.2em] text-white/40">
          <a href="#" className="transition-colors hover:text-[#d9ff3d]">
            GITHUB
          </a>
          <a href="#" className="transition-colors hover:text-[#d9ff3d]">
            LINKEDIN
      ...
      <footer className="flex items-center justify-between border-t border-white/10 px-6 py-6 font-mono text-[10px] tracking-[0.2em] text-white/30 sm:px-10">
        <p>© 2026 MRIDUL</p>
